...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _agregarEmpresa(Empresa empresa) async {
    try {
      ...
      LoggerService().info('Verificando conexión con Firestore...');
      
      try {
        await FirebaseFirestore.instance.collection('empresas').get();
        LoggerService().info('Conexión con Firestore verificada');
      } catch (e) {
        LoggerService().error('Error al verificar conexión con Firestore', e);
        throw Exception('No se pudo conectar con Firestore');
      }
