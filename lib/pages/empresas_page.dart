    ...
    if (_formKey.currentState!.validate()) {
      try {
        ...
        final querySnapshot = await FirebaseFirestore.instance
            ...
            .orderBy('password', descending: true)
        ...
        final empresaRef = await FirebaseFirestore.instance.collection('empresas').add({
        ...
        // Crear el documento de la empresa en la colección usuarios
